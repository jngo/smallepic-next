...
- `src/components/ui/menubar.tsx`: raised dropdown content above desktop windows and added a token-backed opaque paint layer so menu surfaces remain readable.
