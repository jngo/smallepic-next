...
export default function Home() {
  ...
  return (
    <div className="w-svw h-svh relative overflow-clip">
      ...
      <Window id="documentation_hub_case_study" ref={documentationHubCaseStudyRef} className="w-200 left-1/2 top-1/2 -translate-1/2 @container" onClose={() => closeWindow("documentation_hub_case_study", setShowDocumentationHubCaseStudy)}>
