...
const WINDOW_ROUTE_NODES: Record<WindowKey, WindowRouteNode> = {
  ...
  granolaSync: { segment: "granola-sync", parent: "exploration" },
  meetingTranscriber: { segment: "meeting-transcriber", parent: "exploration" },
...
const WINDOW_COMPONENT_ID_BY_KEY: Record<WindowKey, string> = {
  ...
  granolaSync: "granola_sync",
  meetingTranscriber: "meeting_transcriber",
