...
export default function JohnNgoWindow({ onClose, windowRef, onFocus }: JohnNgoWindowProps) {
  return (
    <Window id="john_ngo" ref={windowRef} className="w-125 left-1/2 top-1/2 -translate-1/2" onClose={onClose} onFocus={onFocus}>
