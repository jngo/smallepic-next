  ...
  return (
    <Window id="exploration" ref={windowRef} defaultView="list" className="w-210 left-4 top-14" onClose={onClose}>
      ...
      <WindowContent view="icon">
        <button onClick={onShowMeetingTranscriber} className="desktop-item w-28">
          <Mic strokeWidth={0.8} className="size-12"/>
          <span>meeting-transcriber.html</span>
        </button>
        <button onClick={onShowGranolaSync} className="desktop-item w-28">
          <CalendarSync strokeWidth={0.8} className="size-12"/>
          <span>granola-sync.html</span>
        </button>
        <button onClick={onShowSynthesiser} className="desktop-item w-28">
          <Network strokeWidth={0.8} className="size-12"/>
          <span>synthesiser.html</span>
        </button>
        <button onClick={onShowPodscriber} className="desktop-item w-28">
          <Podcast strokeWidth={0.8} className="size-12"/>
          <span>podscriber.html</span>
        </button>
        <button onClick={onShowMermaidViewer} className="desktop-item w-28">
          <ScanText strokeWidth={0.8} className="size-12"/>
          <span>mermaid-viewer.html</span>
        </button>
        <button onClick={onShowFilmsAndConversations} className="desktop-item w-28">
          <Clapperboard strokeWidth={0.8} className="size-12"/>
          <span>films-and-conversations.html</span>
        </button>
        <button onClick={onShowBooksAndConversations} className="desktop-item w-28">
      ...
      <WindowContent view="list" className="@container">
        <ul>
          <li className="flex flex-col @3xl:flex-row @3xl:items-center @3xl:gap-4 pb-1">
            <span className="flex-none font-serif @3xl:font-sans text-lg @3xl:text-base"><button onClick={onShowMeetingTranscriber} className="desktop-list-link">Meeting Transcriber</button></span>
          ...
          <li className="flex flex-col @3xl:flex-row @3xl:items-center @3xl:gap-4 border-t py-1">
            <span className="flex-none font-serif @3xl:font-sans text-lg @3xl:text-base"><button onClick={onShowGranolaSync} className="desktop-list-link">Granola Sync</button></span>
            <span className="grow">Export Granola meeting transcripts as Markdown files.</span>
          </li>
          <li className="flex flex-col @3xl:flex-row @3xl:items-center @3xl:gap-4 border-t py-1">
            <span className="flex-none font-serif @3xl:font-sans text-lg @3xl:text-base"><button onClick={onShowSynthesiser} className="desktop-list-link">Synthesiser</button></span>
            <span className="grow">Generate a Minto Pyramid synthesis of any content.</span>
          </li>
          <li className="flex flex-col @3xl:flex-row @3xl:items-center @3xl:gap-4 border-t py-1">
            <span className="flex-none font-serif @3xl:font-sans text-lg @3xl:text-base"><button onClick={onShowPodscriber} className="desktop-list-link">Podscriber</button></span>
            <span className="grow">Transcribe podcast episodes and send them to your read-it-later queue.</span>
          </li>
          <li className="flex flex-col @3xl:flex-row @3xl:items-center @3xl:gap-4 border-t py-1">
            <span className="flex-none font-serif @3xl:font-sans text-lg @3xl:text-base"><button onClick={onShowMermaidViewer} className="desktop-list-link">Mermaid Viewer</button></span>
            <span className="grow">A lightweight, mobile-friendly Mermaid diagram viewer.</span>
          </li>
          <li className="flex flex-col @3xl:flex-row @3xl:items-center @3xl:gap-4 border-t py-1">
            <span className="flex-none font-serif @3xl:font-sans text-lg @3xl:text-base"><button onClick={onShowFilmsAndConversations} className="desktop-list-link">Films & Conversations</button></span>
          ...
          <li className="flex flex-col @3xl:flex-row @3xl:items-center @3xl:gap-4 border-t pt-1">
            <span className="flex-none font-serif @3xl:font-sans text-lg @3xl:text-base"><button onClick={onShowBooksAndConversations} className="desktop-list-link">Books & Conversations</button></span>
