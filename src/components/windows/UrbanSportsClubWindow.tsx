  ...
  return (
    <Window id="urban_sports_club" ref={windowRef} className="w-125 left-1/2 top-1/2 -translate-1/2" onClose={onClose}>
      ...
      <WindowContent>
        ...
        <p className="font-serif text-xl mb-2">I laid the technical and product foundations for <a href="https://urbansportsclub.com/" target="_blank" rel="noopener noreferrer" className="inline-token-link" onClick={() => track("link_open", { id: "urban_sports_club_site", url: "https://urbansportsclub.com/" })}>Urban Sports Club&apos;s</a> expansion across Europe.</p>
