  ...
  return (
    <Window id="mckinsey_and_company" ref={windowRef} className="w-125 left-1/2 top-1/2 -translate-1/2" onClose={onClose}>
      ...
      <WindowContent>
        ...
        <p className="font-serif text-xl mb-4">I&apos;m currently leading <a href="https://www.mckinsey.com/" target="_blank" rel="noopener noreferrer" className="inline-token-link" onClick={() => track("link_open", { id: "mckinsey_and_company_site", url: "https://www.mckinsey.com/" })}>McKinsey & Company&apos;s</a> in-house product design capability, building the systems tens of thousands of consultants rely on daily.</p>
